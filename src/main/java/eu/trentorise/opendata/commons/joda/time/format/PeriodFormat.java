...
public class PeriodFormat {
     ...
     */
    private static final String BUNDLE_NAME = "eu.trentorise.opendata.commons.joda.time.format.messages";
    /**
     ...
     * {@code eu.trentorise.opendata.commons.joda.time.format.messages}.
     ...
     * and adding it to the {@code eu.trentorise.opendata.commons.joda.time.format.messages} path.
     * <p>
