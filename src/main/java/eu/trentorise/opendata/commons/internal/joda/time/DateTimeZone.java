 ...
 */
package eu.trentorise.opendata.commons.internal.joda.time;
...
import eu.trentorise.opendata.commons.internal.joda.time.chrono.BaseChronology;
import eu.trentorise.opendata.commons.internal.joda.time.field.FieldUtils;
import eu.trentorise.opendata.commons.internal.joda.time.format.DateTimeFormatter;
import eu.trentorise.opendata.commons.internal.joda.time.format.DateTimeFormatterBuilder;
import eu.trentorise.opendata.commons.internal.joda.time.format.FormatUtils;
import eu.trentorise.opendata.commons.internal.joda.time.tz.DefaultNameProvider;
import eu.trentorise.opendata.commons.internal.joda.time.tz.FixedDateTimeZone;
import eu.trentorise.opendata.commons.internal.joda.time.tz.NameProvider;
import eu.trentorise.opendata.commons.internal.joda.time.tz.Provider;
import eu.trentorise.opendata.commons.internal.joda.time.tz.UTCProvider;
 ...
 *   {@code eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.Provider}.
 * <li>load {@link ZoneInfoProvider} using the data in the filing system folder
 *   pointed to by system property {@code eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.Folder}.
...
public abstract class DateTimeZone implements Serializable {
     ...
     *   <code>eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.Provider</code>.
     * <li>load <code>ZoneInfoProvider</code> using the data in the filing system folder
     *   pointed to by system property <code>eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.Folder</code>.
    ...
    private static Provider getDefaultProvider() {
        // approach 1
        try {
            String providerClass = System.getProperty("eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.Provider");
        ...
        // approach 2
        try {
            String dataFolder = System.getProperty("eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.Folder");
            if (dataFolder != null) {
                try {
        ...
        // approach 3
        try {
            // odt commented Provider provider = new ZoneInfoProvider("org/joda/time/tz/data");
     ...
     * <p>
     * Tries the system property <code>eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.NameProvider</code>.
    ...
    private static NameProvider getDefaultNameProvider() {
        ...
        try {
            String providerClass = System.getProperty("eu.trentorise.opendata.commons.internal.joda.time.DateTimeZone.NameProvider");
            if (providerClass != null) {
                try {
